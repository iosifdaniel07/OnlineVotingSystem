...
class EUParliamentFragment : Fragment() {

    private var _binding: FragmentEUParliamentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEUParliamentBinding.inflate(inflater, container, false)
        mRecyclerView = binding.root.findViewById(R.id.recyclerViewEuParlament)
        mRecyclerView.layoutManager = LinearLayoutManager(context)

        getList()

        swipeRefreshLayout = binding.root.findViewById(R.id.swipeRefreshEuParlament)
